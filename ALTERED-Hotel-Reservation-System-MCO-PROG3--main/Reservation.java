...
public class Reservation {
    ...
    public String getReservationInfo(ArrayList<MonthDate> monthDateList) {
        ...
        reservationInfo += "Check-in date (Month-Day-Year): " + this.getCheckInDate().get(Calendar.MONTH) + "-" + this.getCheckInDate().get(Calendar.DAY_OF_MONTH) + "-" + this.getCheckInDate().get(Calendar.YEAR) + "\n";
        reservationInfo += "Check-out date (Month-Day-Year): " + this.getCheckOutDate().get(Calendar.MONTH) + "-" + this.getCheckOutDate().get(Calendar.DAY_OF_MONTH) + "-" + this.getCheckOutDate().get(Calendar.YEAR) + "\n";
