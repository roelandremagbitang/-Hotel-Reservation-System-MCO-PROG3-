...
public class Hotel {
    ...
    /**
     * Gives the monthly earnings of the Hotel by going through the price of all the Reservations that the Hotel has for the month.
     *
    ...
    /**
     * Gives the monthDateList of the Hotel.
     *
     * @return monthDateList of the Hotel
     */
    public ArrayList<MonthDate> getMonthDateList() {
